import{s as C}from"./index-D78ukbc2.js";import{s as y}from"./index-BFrv1hlM.js";import{s as f}from"./index-CVez_OLS.js";import{f as _}from"./fetchOptionsMixin-BlPY6uDo.js";import{a as r}from"./axios-DsPaXkF5.js";import{_ as N,k as E,w as I,o as i,a as o,c,e as O,b as m,t as A,d as D,F as P}from"./index-AsvOEnX4.js";import"./index-CRRyXLhS.js";import"./index-D9Wf1plD.js";import"./index-DBdP8zgP.js";import"./index-DFZoNrKN.js";import"./index-CUBRiCCj.js";const V={mixins:[_],data(){return{selectedOptions:{},dynamicOptions:{}}},methods:{async fetchData(){try{const n=await r.get("http://localhost:8082/v4/api/data"),e=this.extractPrefixes(n.data);await Promise.all(e.map(a=>this.fetchAuto(a)))}catch(n){console.error("Error fetching data:",n)}},extractPrefixes(n){return[...new Set(n.map(e=>e.prefix))]},async fetchAuto(n){try{const e=await r.get(`http://localhost:8082/v4/api/data/prefix/${n}`);this.dynamicOptions[n]=e.data.map(a=>({code:a.key,name:a.value})),this.selectedOptions[n]=""}catch(e){console.error(`Error fetching options for prefix ${n}:`,e)}},clearCMI(){sessionStorage.setItem("CMI_ID","")}},mounted(){this.fetchData()}},x={class:""},B=o("h2",null,"Select Examples",-1),b={key:0,class:"card flex flex-col gap-4 w-full mt-8"},M=o("h2",null,"DATA TESTING---",-1),S=o("div",{class:"card flex flex-col gap-4 w-full mt-8"},[o("pre",null,[o("code",null,`
[
  {
    "id": "1234567890",
    "insured": {
